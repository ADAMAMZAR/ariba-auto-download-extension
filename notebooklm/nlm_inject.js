...
// This message is sent EVERY time the script is injected so a reloaded content script
// can get the token immediately.
window.postMessage({
...
if (!window.__nlmInjectLoaded) {
  window.__nlmInjectLoaded = true;
